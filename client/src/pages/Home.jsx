...
const Home = () => {
  const tools = [
    ...
    },
    {
      ...
      description: 'Generate placeholder text in various lengths for your needs.',
    ...
    {
      title: 'Color Picker',
      description: 'Find and convert colors between different formats like HEX and RGB.',
      path: '/color-picker',
      icon: '🎨'    
    },
    {
  ...
  return (
    <div className="container">
      <div className="text-center mb-3 glitch-wrapper">
        <h1 className="page-title rainbow-text glitch">Welcome to BitShelf</h1>
        {/* <p className="page-subtitle">
          Your ultimate collection of developer tools. Everything you need in one place.
        </p> */}

        <p className="page-subtitle code-subtitle-text">
        <TypeAnimation
          sequence={[
            'Your ultimate collection of developer tools. Everything you need in one place.',
            3000,
            '' // clear the text to start over
          ]}
          speed={60}
          repeat={Infinity} // Makes the cursor repeat indefinitely
          cursor={true} // This is the key prop to enable the cursor
        />
       </p>
      ...
      {/* <div className="text-center" style={{ marginTop: '4rem' }}>
        ...
        <div className="retro-features-section" style={{ marginTop: '4rem' }}>
